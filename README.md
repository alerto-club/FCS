...
### 🎯 Обзор проекта
**SmartTech Search API** — это специализированный бэкенд для интернет-магазинов электроники. Проект решает проблему медленной фильтрации и «нулевой» выдачи при опечатках пользователя благодаря интеграции Elasticsearch и Java 21.
